...
class Otf2Handler {
  public:
    ...
    virtual void handleGlobalParadigm(OTF2_Paradigm paradigm,
                                      OTF2_StringRef name,
                                      OTF2_ParadigmClass paradigmClass) = 0;

    virtual void handleGlobalParadigmProperty(OTF2_Paradigm paradigm,
    ...
    virtual void handleGlobalSystemTreeNode(OTF2_SystemTreeNodeRef self,
                                            OTF2_StringRef name,
    ...
    virtual void handleGlobalLocation(OTF2_LocationRef self,
                                      OTF2_StringRef name,
    ...
    virtual void handleGlobalParameter(OTF2_ParameterRef self,
                                       OTF2_StringRef name,
    ...
    virtual void handleGlobalMetricClassRecorder(OTF2_MetricRef metric,
    ...
    virtual void handleGlobalLocationProperty(OTF2_LocationRef location,
                                              OTF2_StringRef name,
                                              OTF2_Type type,
                                              OTF2_AttributeValue value) = 0;
    ...
    virtual void
    handleGlobalCartTopology(OTF2_CartTopologyRef self, OTF2_StringRef name,
                             OTF2_CommRef communicator,
                             uint8_t numberOfDimensions,
                             const OTF2_CartDimensionRef *cartDimensions) = 0;

    virtual void handleGlobalCartCoordinate(OTF2_CartTopologyRef cartTopology,
                                            uint32_t rank,
                                            uint8_t numberOfDimensions,
    ...
    virtual void handleGlobalIoRegularFile(OTF2_IoFileRef self,
                                           OTF2_StringRef name,
    ...
    virtual void handleGlobalCallpathParameter(OTF2_CallpathRef callpath,
    ...
    virtual void handleLocalString(OTF2_LocationRef readLocation,
                                   OTF2_StringRef self, const char *string) = 0;
    ...
    virtual void handleLocalSystemTreeNode(OTF2_LocationRef readLocation,
    ...
    virtual void handleLocalLocation(OTF2_LocationRef readLocation,
                                     OTF2_LocationRef self, OTF2_StringRef name,
                                     OTF2_LocationType locationType,
                                     uint64_t numberOfEvents,
                                     OTF2_LocationGroupRef locationGroup) = 0;
    ...
    virtual void
    handleLocalGroup(OTF2_LocationRef readLocation, OTF2_GroupRef self,
                     OTF2_StringRef name, OTF2_GroupType groupType,
                     OTF2_Paradigm paradigm, OTF2_GroupFlag groupFlags,
                     uint32_t numberOfMembers, const uint64_t *members) = 0;
    ...
    virtual void handleLocalParameter(OTF2_LocationRef readLocation,
    ...
    virtual void handleLocalMetricClassRecorder(OTF2_LocationRef readLocation,
                                                OTF2_MetricRef metric,
                                                OTF2_LocationRef recorder) = 0;

    virtual void handleLocalSystemTreeNodeProperty(
        OTF2_LocationRef readLocation, OTF2_SystemTreeNodeRef systemTreeNode,
        OTF2_StringRef name, OTF2_Type type, OTF2_AttributeValue value) = 0;
    ...
    virtual void handleLocalLocationGroupProperty(
        OTF2_LocationRef readLocation, OTF2_LocationGroupRef locationGroup,
        OTF2_StringRef name, OTF2_Type type, OTF2_AttributeValue value) = 0;

    virtual void handleLocalLocationProperty(OTF2_LocationRef readLocation,
    ...
    virtual void handleLocalCartCoordinate(OTF2_LocationRef readLocation,
    ...
    virtual void handleLocalCallingContextProperty(
    ...
    virtual void handleLocalInterruptGenerator(
        ...
        OTF2_Base base, int64_t exponent, uint64_t period) = 0;
    ...
    virtual void handleLocalIoRegularFile(OTF2_LocationRef readLocation,
                                          OTF2_IoFileRef self,
                                          OTF2_StringRef name,
                                          OTF2_SystemTreeNodeRef scope) = 0;
    ...
    virtual void handleLocalIoPreCreatedHandleState(
        ...
        OTF2_IoAccessMode mode, OTF2_IoStatusFlag statusFlags) = 0;

    virtual void handleLocalCallpathParameter(OTF2_LocationRef readLocation,
    ...
    virtual void handleThreadForkEvent(OTF2_LocationRef location,
                                       OTF2_TimeStamp time,
                                       OTF2_AttributeList *attributes,
                                       OTF2_Paradigm model,
                                       uint32_t numberOfRequestedThreads) = 0;
    ...
    virtual void handleThreadAcquireLockEvent(OTF2_LocationRef location,
                                              OTF2_TimeStamp time,
                                              OTF2_AttributeList *attributes,
                                              OTF2_Paradigm model,
                                              uint32_t lockID,
    ...
    virtual void handleThreadReleaseLockEvent(OTF2_LocationRef location,
                                              OTF2_TimeStamp time,
                                              OTF2_AttributeList *attributes,
                                              OTF2_Paradigm model,
                                              uint32_t lockID,
    ...
    virtual void handleThreadTaskCreateEvent(OTF2_LocationRef location,
                                             OTF2_TimeStamp time,
                                             OTF2_AttributeList *attributes,
    ...
    virtual void handleThreadTaskSwitchEvent(OTF2_LocationRef location,
                                             OTF2_TimeStamp time,
                                             OTF2_AttributeList *attributes,
                                             OTF2_CommRef threadTeam,
                                             uint32_t creatingThread,
    ...
    virtual void handleThreadTaskCompleteEvent(OTF2_LocationRef location,
                                               OTF2_TimeStamp time,
                                               OTF2_AttributeList *attributes,
                                               OTF2_CommRef threadTeam,
                                               uint32_t creatingThread,
    ...
    virtual void handleIoCreateHandleEvent(OTF2_LocationRef location,
                                           OTF2_TimeStamp time,
                                           OTF2_AttributeList *attributes,
    ...
    virtual void handleIoDuplicateHandleEvent(
        ...
        OTF2_IoHandleRef newHandle, OTF2_IoStatusFlag statusFlags) = 0;
    ...
    virtual void handleProgramBeginEvent(
        OTF2_LocationRef location, OTF2_TimeStamp time,
