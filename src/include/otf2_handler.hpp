...
class Otf2Handler {
  public:
    ...
    virtual void handleString(OTF2_StringRef self, const char *string) = 0;
    ...
    virtual void handleMetricMember(OTF2_MetricMemberRef self,
                                    OTF2_StringRef name,
                                    OTF2_StringRef description,
    ...
    virtual void handleCartDimension(OTF2_CartDimensionRef self,
