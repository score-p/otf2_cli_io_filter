...
class Otf2Handler
{
  public:
    ...
    virtual void
    handleLocalString(OTF2_LocationRef readLocation, OTF2_StringRef self, const char *string) = 0;
    ...
    virtual void
    handleLocalRmaWin(OTF2_LocationRef readLocation, OTF2_RmaWinRef self, OTF2_StringRef name, OTF2_CommRef comm) = 0;

    virtual void
    handleLocalMetricClassRecorder(OTF2_LocationRef readLocation, OTF2_MetricRef metric, OTF2_LocationRef recorder) = 0;
