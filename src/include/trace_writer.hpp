...
class TraceWriter : public Otf2Handler
{
  public:
    /*
     * Initialize OTF2 archive, event
     * and definition writer.
     *
     * @param path specify the folder of
     * trace to be written
     */
    ...
    virtual void
    handleLocalString(OTF2_LocationRef readLocation, OTF2_StringRef self, const char *string) override;
  ...
  private:
    ...
    Filter<LocalSystemTreeNodePropertyFilter>  m_local_SystemTreeNodeProperty_filter;
    Filter<LocalSystemTreeNodeDomainFilter>    m_local_SystemTreeNodeDomain_filter;
    Filter<LocalLocationGroupPropertyFilter>   m_local_LocationGroupProperty_filter;
    ...
    Filter<LocalCallingContextPropertyFilter>  m_local_CallingContextProperty_filter;
    ...
    Filter<LocalIoPreCreatedHandleStateFilter> m_local_IoPreCreatedHandleState_filter;
