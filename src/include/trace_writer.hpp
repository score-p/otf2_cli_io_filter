...
class TraceWriter : public Otf2Handler {
  public:
    ...
    void
    registerClockPropertiesGlobalFilter(GlobalClockPropertiesFilter filter);

    void registerParadigmGlobalFilter(GlobalParadigmFilter filter);

    void
    registerParadigmPropertyGlobalFilter(GlobalParadigmPropertyFilter filter);

    void registerIoParadigmGlobalFilter(GlobalIoParadigmFilter filter);

    void registerStringGlobalFilter(GlobalStringFilter filter);

    void registerAttributeGlobalFilter(GlobalAttributeFilter filter);

    void registerSystemTreeNodeGlobalFilter(GlobalSystemTreeNodeFilter filter);

    void registerLocationGroupGlobalFilter(GlobalLocationGroupFilter filter);

    void registerLocationGlobalFilter(GlobalLocationFilter filter);

    void registerRegionGlobalFilter(GlobalRegionFilter filter);

    void registerCallsiteGlobalFilter(GlobalCallsiteFilter filter);

    void registerCallpathGlobalFilter(GlobalCallpathFilter filter);

    void registerGroupGlobalFilter(GlobalGroupFilter filter);

    void registerMetricMemberGlobalFilter(GlobalMetricMemberFilter filter);

    void registerMetricClassGlobalFilter(GlobalMetricClassFilter filter);

    void registerMetricInstanceGlobalFilter(GlobalMetricInstanceFilter filter);

    void registerCommGlobalFilter(GlobalCommFilter filter);

    void registerParameterGlobalFilter(GlobalParameterFilter filter);

    void registerRmaWinGlobalFilter(GlobalRmaWinFilter filter);

    void registerMetricClassRecorderGlobalFilter(
        GlobalMetricClassRecorderFilter filter);

    void registerSystemTreeNodePropertyGlobalFilter(
        GlobalSystemTreeNodePropertyFilter filter);

    void registerSystemTreeNodeDomainGlobalFilter(
        GlobalSystemTreeNodeDomainFilter filter);

    void registerLocationGroupPropertyGlobalFilter(
        GlobalLocationGroupPropertyFilter filter);

    void
    registerLocationPropertyGlobalFilter(GlobalLocationPropertyFilter filter);

    void registerCartDimensionGlobalFilter(GlobalCartDimensionFilter filter);

    void registerCartTopologyGlobalFilter(GlobalCartTopologyFilter filter);

    void registerCartCoordinateGlobalFilter(GlobalCartCoordinateFilter filter);

    void registerSourceCodeLocationGlobalFilter(
        GlobalSourceCodeLocationFilter filter);

    void registerCallingContextGlobalFilter(GlobalCallingContextFilter filter);

    void registerCallingContextPropertyGlobalFilter(
        GlobalCallingContextPropertyFilter filter);

    void registerInterruptGeneratorGlobalFilter(
        GlobalInterruptGeneratorFilter filter);

    void registerIoFilePropertyGlobalFilter(GlobalIoFilePropertyFilter filter);

    void registerIoRegularFileGlobalFilter(GlobalIoRegularFileFilter filter);

    void registerIoDirectoryGlobalFilter(GlobalIoDirectoryFilter filter);

    void registerIoHandleGlobalFilter(GlobalIoHandleFilter filter);

    void registerIoPreCreatedHandleStateGlobalFilter(
        GlobalIoPreCreatedHandleStateFilter filter);

    void
    registerCallpathParameterGlobalFilter(GlobalCallpathParameterFilter filter);

    /*
     * Register local definition filter
     */

    void registerMappingTableLocalFilter(LocalMappingTableFilter filter);

    void registerClockOffsetLocalFilter(LocalClockOffsetFilter filter);

    void registerStringLocalFilter(LocalStringFilter filter);

    void registerAttributeLocalFilter(LocalAttributeFilter filter);

    void registerSystemTreeNodeLocalFilter(LocalSystemTreeNodeFilter filter);

    void registerLocationGroupLocalFilter(LocalLocationGroupFilter filter);

    void registerLocationLocalFilter(LocalLocationFilter filter);

    void registerRegionLocalFilter(LocalRegionFilter filter);

    void registerCallsiteLocalFilter(LocalCallsiteFilter filter);

    void registerCallpathLocalFilter(LocalCallpathFilter filter);

    void registerGroupLocalFilter(LocalGroupFilter filter);

    void registerMetricMemberLocalFilter(LocalMetricMemberFilter filter);

    void registerMetricClassLocalFilter(LocalMetricClassFilter filter);

    void registerMetricInstanceLocalFilter(LocalMetricInstanceFilter filter);

    void registerCommLocalFilter(LocalCommFilter filter);

    void registerParameterLocalFilter(LocalParameterFilter filter);

    void registerRmaWinLocalFilter(LocalRmaWinFilter filter);

    void registerMetricClassRecorderLocalFilter(
        LocalMetricClassRecorderFilter filter);

    void registerSystemTreeNodePropertyLocalFilter(
        LocalSystemTreeNodePropertyFilter filter);

    void registerSystemTreeNodeDomainLocalFilter(
        LocalSystemTreeNodeDomainFilter filter);

    void registerLocationGroupPropertyLocalFilter(
        LocalLocationGroupPropertyFilter filter);

    void
    registerLocationPropertyLocalFilter(LocalLocationPropertyFilter filter);

    void registerCartDimensionLocalFilter(LocalCartDimensionFilter filter);

    void registerCartTopologyLocalFilter(LocalCartTopologyFilter filter);

    void registerCartCoordinateLocalFilter(LocalCartCoordinateFilter filter);

    void
    registerSourceCodeLocationLocalFilter(LocalSourceCodeLocationFilter filter);

    void registerCallingContextLocalFilter(LocalCallingContextFilter filter);

    void registerCallingContextPropertyLocalFilter(
        LocalCallingContextPropertyFilter filter);

    void
    registerInterruptGeneratorLocalFilter(LocalInterruptGeneratorFilter filter);

    void registerIoFilePropertyLocalFilter(LocalIoFilePropertyFilter filter);

    void registerIoRegularFileLocalFilter(LocalIoRegularFileFilter filter);

    void registerIoDirectoryLocalFilter(LocalIoDirectoryFilter filter);

    void registerIoHandleLocalFilter(LocalIoHandleFilter filter);

    void registerIoPreCreatedHandleStateLocalFilter(
        LocalIoPreCreatedHandleStateFilter filter);

    void
    registerCallpathParameterLocalFilter(LocalCallpathParameterFilter filter);

    /*
     * Register event filter
     */

    void registerBufferFlushEventFilter(EventBufferFlushFilter filter);

    void
    registerMeasurementOnOffEventFilter(EventMeasurementOnOffFilter filter);

    void registerEnterEventFilter(EventEnterFilter filter);

    void registerLeaveEventFilter(EventLeaveFilter filter);

    void registerMpiSendEventFilter(EventMpiSendFilter filter);

    void registerMpiIsendEventFilter(EventMpiIsendFilter filter);

    void
    registerMpiIsendCompleteEventFilter(EventMpiIsendCompleteFilter filter);

    void registerMpiIrecvRequestEventFilter(EventMpiIrecvRequestFilter filter);

    void registerMpiRecvEventFilter(EventMpiRecvFilter filter);

    void registerMpiIrecvEventFilter(EventMpiIrecvFilter filter);

    void registerMpiRequestTestEventFilter(EventMpiRequestTestFilter filter);

    void registerMpiRequestCancelledEventFilter(
        EventMpiRequestCancelledFilter filter);

    void
    registerMpiCollectiveBeginEventFilter(EventMpiCollectiveBeginFilter filter);

    void
    registerMpiCollectiveEndEventFilter(EventMpiCollectiveEndFilter filter);

    void registerOmpForkEventFilter(EventOmpForkFilter filter);

    void registerOmpJoinEventFilter(EventOmpJoinFilter filter);

    void registerOmpAcquireLockEventFilter(EventOmpAcquireLockFilter filter);

    void registerOmpReleaseLockEventFilter(EventOmpReleaseLockFilter filter);

    void registerOmpTaskCreateEventFilter(EventOmpTaskCreateFilter filter);

    void registerOmpTaskSwitchEventFilter(EventOmpTaskSwitchFilter filter);

    void registerOmpTaskCompleteEventFilter(EventOmpTaskCompleteFilter filter);

    void registerMetricEventFilter(EventMetricFilter filter);

    void registerParameterStringEventFilter(EventParameterStringFilter filter);

    void registerParameterIntEventFilter(EventParameterIntFilter filter);

    void registerParameterUnsignedIntEventFilter(
        EventParameterUnsignedIntFilter filter);

    void registerRmaWinCreateEventFilter(EventRmaWinCreateFilter filter);

    void registerRmaWinDestroyEventFilter(EventRmaWinDestroyFilter filter);

    void
    registerRmaCollectiveBeginEventFilter(EventRmaCollectiveBeginFilter filter);

    void
    registerRmaCollectiveEndEventFilter(EventRmaCollectiveEndFilter filter);

    void registerRmaGroupSyncEventFilter(EventRmaGroupSyncFilter filter);

    void registerRmaRequestLockEventFilter(EventRmaRequestLockFilter filter);

    void registerRmaAcquireLockEventFilter(EventRmaAcquireLockFilter filter);

    void registerRmaTryLockEventFilter(EventRmaTryLockFilter filter);

    void registerRmaReleaseLockEventFilter(EventRmaReleaseLockFilter filter);

    void registerRmaSyncEventFilter(EventRmaSyncFilter filter);

    void registerRmaWaitChangeEventFilter(EventRmaWaitChangeFilter filter);

    void registerRmaPutEventFilter(EventRmaPutFilter filter);

    void registerRmaGetEventFilter(EventRmaGetFilter filter);

    void registerRmaAtomicEventFilter(EventRmaAtomicFilter filter);

    void registerRmaOpCompleteBlockingEventFilter(
        EventRmaOpCompleteBlockingFilter filter);

    void registerRmaOpCompleteNonBlockingEventFilter(
        EventRmaOpCompleteNonBlockingFilter filter);

    void registerRmaOpTestEventFilter(EventRmaOpTestFilter filter);

    void registerRmaOpCompleteRemoteEventFilter(
        EventRmaOpCompleteRemoteFilter filter);

    void registerThreadForkEventFilter(EventThreadForkFilter filter);

    void registerThreadJoinEventFilter(EventThreadJoinFilter filter);

    void registerThreadTeamBeginEventFilter(EventThreadTeamBeginFilter filter);

    void registerThreadTeamEndEventFilter(EventThreadTeamEndFilter filter);

    void
    registerThreadAcquireLockEventFilter(EventThreadAcquireLockFilter filter);

    void
    registerThreadReleaseLockEventFilter(EventThreadReleaseLockFilter filter);

    void
    registerThreadTaskCreateEventFilter(EventThreadTaskCreateFilter filter);

    void
    registerThreadTaskSwitchEventFilter(EventThreadTaskSwitchFilter filter);

    void
    registerThreadTaskCompleteEventFilter(EventThreadTaskCompleteFilter filter);

    void registerThreadCreateEventFilter(EventThreadCreateFilter filter);

    void registerThreadBeginEventFilter(EventThreadBeginFilter filter);

    void registerThreadWaitEventFilter(EventThreadWaitFilter filter);

    void registerThreadEndEventFilter(EventThreadEndFilter filter);

    void registerCallingContextEnterEventFilter(
        EventCallingContextEnterFilter filter);

    void registerCallingContextLeaveEventFilter(
        EventCallingContextLeaveFilter filter);

    void registerCallingContextSampleEventFilter(
        EventCallingContextSampleFilter filter);

    void registerIoCreateHandleEventFilter(EventIoCreateHandleFilter filter);

    void registerIoDestroyHandleEventFilter(EventIoDestroyHandleFilter filter);

    void
    registerIoDuplicateHandleEventFilter(EventIoDuplicateHandleFilter filter);

    void registerIoSeekEventFilter(EventIoSeekFilter filter);

    void registerIoChangeStatusFlagsEventFilter(
        EventIoChangeStatusFlagsFilter filter);

    void registerIoDeleteFileEventFilter(EventIoDeleteFileFilter filter);

    void
    registerIoOperationBeginEventFilter(EventIoOperationBeginFilter filter);

    void registerIoOperationTestEventFilter(EventIoOperationTestFilter filter);

    void
    registerIoOperationIssuedEventFilter(EventIoOperationIssuedFilter filter);

    void registerIoOperationCompleteEventFilter(
        EventIoOperationCompleteFilter filter);

    void registerIoOperationCancelledEventFilter(
        EventIoOperationCancelledFilter filter);

    void registerIoAcquireLockEventFilter(EventIoAcquireLockFilter filter);

    void registerIoReleaseLockEventFilter(EventIoReleaseLockFilter filter);

    void registerIoTryLockEventFilter(EventIoTryLockFilter filter);

    void registerProgramBeginEventFilter(EventProgramBeginFilter filter);

    void registerProgramEndEventFilter(EventProgramEndFilter filter);
