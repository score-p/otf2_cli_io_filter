...
OTF2_CallbackCode BufferFlushCb(OTF2_LocationRef location, OTF2_TimeStamp time,
    ...
    tr->writer().writeBufferFlushEvent(location, time, attributes, stopTime);
...
OTF2_CallbackCode MeasurementOnOffCb(OTF2_LocationRef location,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeMeasurementOnOffEvent(location, time, attributes,
                                            measurementMode);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode EnterCb(OTF2_LocationRef location, OTF2_TimeStamp time,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeEnterEvent(location, time, attributes, region);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode LeaveCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                          ...
                          OTF2_RegionRef region) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeLeaveEvent(location, time, attributes, region);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode MpiSendCb(OTF2_LocationRef location, OTF2_TimeStamp time,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeMpiSendEvent(location, time, attributes, receiver,
...
OTF2_CallbackCode MpiIsendCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                             ...
                             uint64_t requestID) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeMpiIsendEvent(location, time, attributes, receiver,
...
OTF2_CallbackCode MpiIsendCompleteCb(OTF2_LocationRef location,
                                     ...
                                     uint64_t requestID) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeMpiIsendCompleteEvent(location, time, attributes,
                                            requestID);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode MpiIrecvRequestCb(OTF2_LocationRef location,
                                    ...
                                    uint64_t requestID) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeMpiIrecvRequestEvent(location, time, attributes,
                                           requestID);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode MpiRecvCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                            ...
                            uint32_t msgTag, uint64_t msgLength) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeMpiRecvEvent(location, time, attributes, sender,
                                   communicator, msgTag, msgLength);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode MpiIrecvCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                             ...
                             uint64_t requestID) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeMpiIrecvEvent(location, time, attributes, sender,
                                    communicator, msgTag, msgLength, requestID);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode MpiRequestTestCb(OTF2_LocationRef location,
                                   ...
                                   uint64_t requestID) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeMpiRequestTestEvent(location, time, attributes,
                                          requestID);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode MpiRequestCancelledCb(OTF2_LocationRef location,
                                        ...
                                        uint64_t requestID) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeMpiRequestCancelledEvent(location, time, attributes,
                                               requestID);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode MpiCollectiveBeginCb(OTF2_LocationRef location,
                                       ...
                                       OTF2_AttributeList *attributes) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeMpiCollectiveBeginEvent(location, time, attributes);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode MpiCollectiveEndCb(OTF2_LocationRef location,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeMpiCollectiveEndEvent(location, time, attributes,
...
OTF2_CallbackCode OmpForkCb(OTF2_LocationRef location, OTF2_TimeStamp time,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeOmpForkEvent(location, time, attributes,
...
OTF2_CallbackCode OmpJoinCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                            void *userData, OTF2_AttributeList *attributes) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeOmpJoinEvent(location, time, attributes);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode OmpAcquireLockCb(OTF2_LocationRef location,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeOmpAcquireLockEvent(location, time, attributes, lockID,
                                          acquisitionOrder);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode OmpReleaseLockCb(OTF2_LocationRef location,
                                   ...
                                   uint32_t lockID, uint32_t acquisitionOrder) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeOmpReleaseLockEvent(location, time, attributes, lockID,
                                          acquisitionOrder);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode OmpTaskCreateCb(OTF2_LocationRef location,
                                  ...
                                  uint64_t taskID) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeOmpTaskCreateEvent(location, time, attributes, taskID);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode OmpTaskSwitchCb(OTF2_LocationRef location,
                                  ...
                                  uint64_t taskID) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeOmpTaskSwitchEvent(location, time, attributes, taskID);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode OmpTaskCompleteCb(OTF2_LocationRef location,
                                    ...
                                    uint64_t taskID) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeOmpTaskCompleteEvent(location, time, attributes, taskID);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode MetricCb(OTF2_LocationRef location, OTF2_TimeStamp time,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeMetricEvent(location, time, attributes, metric,
...
OTF2_CallbackCode ParameterStringCb(OTF2_LocationRef location,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeParameterStringEvent(location, time, attributes,
                                           parameter, string);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode ParameterIntCb(OTF2_LocationRef location, OTF2_TimeStamp time,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeParameterIntEvent(location, time, attributes, parameter,
                                        value);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode ParameterUnsignedIntCb(OTF2_LocationRef location,
                                         ...
                                         uint64_t value) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeParameterUnsignedIntEvent(location, time, attributes,
                                                parameter, value);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode RmaWinCreateCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                                 ...
                                 OTF2_RmaWinRef win) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaWinCreateEvent(location, time, attributes, win);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode RmaWinDestroyCb(OTF2_LocationRef location,
                                  ...
                                  OTF2_RmaWinRef win) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaWinDestroyEvent(location, time, attributes, win);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode RmaCollectiveBeginCb(OTF2_LocationRef location,
                                       ...
                                       OTF2_AttributeList *attributes) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaCollectiveBeginEvent(location, time, attributes);
    return OTF2_CALLBACK_SUCCESS;
}
...
RmaCollectiveEndCb(OTF2_LocationRef location, OTF2_TimeStamp time,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaCollectiveEndEvent(location, time, attributes,
...
OTF2_CallbackCode RmaGroupSyncCb(OTF2_LocationRef location, OTF2_TimeStamp time,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaGroupSyncEvent(location, time, attributes, syncLevel,
                                        win, group);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode RmaRequestLockCb(OTF2_LocationRef location,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaRequestLockEvent(location, time, attributes, win,
...
OTF2_CallbackCode RmaAcquireLockCb(OTF2_LocationRef location,
                                   ...
                                   uint64_t lockId, OTF2_LockType lockType) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaAcquireLockEvent(location, time, attributes, win,
                                          remote, lockId, lockType);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode RmaTryLockCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                               ...
                               uint64_t lockId, OTF2_LockType lockType) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaTryLockEvent(location, time, attributes, win, remote,
                                      lockId, lockType);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode RmaReleaseLockCb(OTF2_LocationRef location,
                                   ...
                                   uint64_t lockId) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaReleaseLockEvent(location, time, attributes, win,
                                          remote, lockId);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode RmaSyncCb(OTF2_LocationRef location, OTF2_TimeStamp time,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaSyncEvent(location, time, attributes, win, remote,
                                   syncType);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode RmaWaitChangeCb(OTF2_LocationRef location,
                                  ...
                                  OTF2_RmaWinRef win) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaWaitChangeEvent(location, time, attributes, win);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode RmaPutCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                           ...
                           uint64_t matchingId) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaPutEvent(location, time, attributes, win, remote,
                                  bytes, matchingId);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode RmaGetCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                           ...
                           uint64_t matchingId) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaGetEvent(location, time, attributes, win, remote,
                                  bytes, matchingId);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode RmaAtomicCb(OTF2_LocationRef location, OTF2_TimeStamp time,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaAtomicEvent(location, time, attributes, win, remote,
                                     type, bytesSent, bytesReceived,
                                     matchingId);
    return OTF2_CALLBACK_SUCCESS;
}

OTF2_CallbackCode RmaOpCompleteBlockingCb(OTF2_LocationRef location,
                                          OTF2_TimeStamp time, void *userData,
                                          OTF2_AttributeList *attributes,
                                          OTF2_RmaWinRef win,
                                          uint64_t matchingId) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaOpCompleteBlockingEvent(location, time, attributes,
                                                 win, matchingId);
    return OTF2_CALLBACK_SUCCESS;
}
...
RmaOpCompleteNonBlockingCb(OTF2_LocationRef location, OTF2_TimeStamp time,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaOpCompleteNonBlockingEvent(location, time, attributes,
                                                    win, matchingId);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode RmaOpTestCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                              ...
                              OTF2_RmaWinRef win, uint64_t matchingId) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaOpTestEvent(location, time, attributes, win,
                                     matchingId);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode RmaOpCompleteRemoteCb(OTF2_LocationRef location,
                                        ...
                                        uint64_t matchingId) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeRmaOpCompleteRemoteEvent(location, time, attributes, win,
                                               matchingId);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode ThreadForkCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                               ...
                               uint32_t numberOfRequestedThreads) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeThreadForkEvent(location, time, attributes, model,
                                      numberOfRequestedThreads);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode ThreadJoinCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                               ...
                               OTF2_Paradigm model) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeThreadJoinEvent(location, time, attributes, model);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode ThreadTeamBeginCb(OTF2_LocationRef location,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeThreadTeamBeginEvent(location, time, attributes,
                                           threadTeam);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode ThreadTeamEndCb(OTF2_LocationRef location,
                                  ...
                                  OTF2_CommRef threadTeam) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeThreadTeamEndEvent(location, time, attributes,
                                         threadTeam);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode ThreadAcquireLockCb(OTF2_LocationRef location,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeThreadAcquireLockEvent(location, time, attributes, model,
...
OTF2_CallbackCode ThreadReleaseLockCb(OTF2_LocationRef location,
                                      ...
                                      uint32_t acquisitionOrder) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeThreadReleaseLockEvent(location, time, attributes, model,
                                             lockID, acquisitionOrder);
    return OTF2_CALLBACK_SUCCESS;
}

OTF2_CallbackCode ThreadTaskCreateCb(OTF2_LocationRef location,
                                     OTF2_TimeStamp time, void *userData,
                                     OTF2_AttributeList *attributes,
                                     OTF2_CommRef threadTeam,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeThreadTaskCreateEvent(location, time, attributes,
                                            threadTeam, creatingThread,
                                            generationNumber);
    return OTF2_CALLBACK_SUCCESS;
}

OTF2_CallbackCode ThreadTaskSwitchCb(OTF2_LocationRef location,
                                     OTF2_TimeStamp time, void *userData,
                                     OTF2_AttributeList *attributes,
                                     OTF2_CommRef threadTeam,
                                     uint32_t creatingThread,
                                     uint32_t generationNumber) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeThreadTaskSwitchEvent(location, time, attributes,
                                            threadTeam, creatingThread,
                                            generationNumber);
    return OTF2_CALLBACK_SUCCESS;
}

OTF2_CallbackCode ThreadTaskCompleteCb(OTF2_LocationRef location,
                                       OTF2_TimeStamp time, void *userData,
                                       OTF2_AttributeList *attributes,
                                       OTF2_CommRef threadTeam,
                                       uint32_t creatingThread,
                                       uint32_t generationNumber) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeThreadTaskCompleteEvent(location, time, attributes,
                                              threadTeam, creatingThread,
                                              generationNumber);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode ThreadCreateCb(OTF2_LocationRef location, OTF2_TimeStamp time,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeThreadCreateEvent(location, time, attributes,
...
OTF2_CallbackCode ThreadBeginCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                                ...
                                uint64_t sequenceCount) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeThreadBeginEvent(location, time, attributes,
                                       threadContingent, sequenceCount);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode ThreadWaitCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                               ...
                               uint64_t sequenceCount) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeThreadWaitEvent(location, time, attributes,
                                      threadContingent, sequenceCount);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode ThreadEndCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                              ...
                              uint64_t sequenceCount) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeThreadEndEvent(location, time, attributes,
                                     threadContingent, sequenceCount);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode CallingContextEnterCb(OTF2_LocationRef location,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeCallingContextEnterEvent(location, time, attributes,
...
OTF2_CallbackCode CallingContextLeaveCb(OTF2_LocationRef location,
                                        ...
                                        OTF2_CallingContextRef callingContext) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeCallingContextLeaveEvent(location, time, attributes,
                                               callingContext);
    return OTF2_CALLBACK_SUCCESS;
}

OTF2_CallbackCode CallingContextSampleCb(
    OTF2_LocationRef location, OTF2_TimeStamp time, void *userData,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeCallingContextSampleEvent(location, time, attributes,
                                                callingContext, unwindDistance,
                                                interruptGenerator);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode
IoCreateHandleCb(OTF2_LocationRef location, OTF2_TimeStamp time, void *userData,
                 OTF2_AttributeList *attributes, OTF2_IoHandleRef handle,
                 OTF2_IoAccessMode mode, OTF2_IoCreationFlag creationFlags,
                 OTF2_IoStatusFlag statusFlags) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeIoCreateHandleEvent(location, time, attributes, handle,
...
OTF2_CallbackCode IoDestroyHandleCb(OTF2_LocationRef location,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeIoDestroyHandleEvent(location, time, attributes, handle);
    return OTF2_CALLBACK_SUCCESS;
}

OTF2_CallbackCode IoDuplicateHandleCb(OTF2_LocationRef location,
                                      OTF2_TimeStamp time, void *userData,
                                      OTF2_AttributeList *attributes,
                                      ...
                                      OTF2_IoStatusFlag statusFlags) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeIoDuplicateHandleEvent(location, time, attributes,
...
OTF2_CallbackCode IoSeekCb(OTF2_LocationRef location, OTF2_TimeStamp time,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeIoSeekEvent(location, time, attributes, handle,
...
OTF2_CallbackCode IoChangeStatusFlagsCb(OTF2_LocationRef location,
                                        ...
                                        OTF2_IoStatusFlag statusFlags) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeIoChangeStatusFlagsEvent(location, time, attributes,
                                               handle, statusFlags);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode IoDeleteFileCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                                 ...
                                 OTF2_IoFileRef file) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeIoDeleteFileEvent(location, time, attributes, ioParadigm,
                                        file);
    return OTF2_CALLBACK_SUCCESS;
}

OTF2_CallbackCode
IoOperationBeginCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                   void *userData, OTF2_AttributeList *attributes,
                   OTF2_IoHandleRef handle, OTF2_IoOperationMode mode,
                   OTF2_IoOperationFlag operationFlags, uint64_t bytesRequest,
                   uint64_t matchingId) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeIoOperationBeginEvent(location, time, attributes, handle,
...
OTF2_CallbackCode IoOperationTestCb(OTF2_LocationRef location,
                                    ...
                                    uint64_t matchingId) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeIoOperationTestEvent(location, time, attributes, handle,
                                           matchingId);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode IoOperationIssuedCb(OTF2_LocationRef location,
                                      ...
                                      uint64_t matchingId) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeIoOperationIssuedEvent(location, time, attributes, handle,
                                             matchingId);
    return OTF2_CALLBACK_SUCCESS;
}

OTF2_CallbackCode IoOperationCompleteCb(OTF2_LocationRef location,
                                        OTF2_TimeStamp time, void *userData,
                                        OTF2_AttributeList *attributes,
                                        OTF2_IoHandleRef handle,
                                        ...
                                        uint64_t matchingId) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeIoOperationCompleteEvent(location, time, attributes,
...
OTF2_CallbackCode IoOperationCancelledCb(OTF2_LocationRef location,
                                         ...
                                         uint64_t matchingId) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeIoOperationCancelledEvent(location, time, attributes,
                                                handle, matchingId);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode IoAcquireLockCb(OTF2_LocationRef location,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeIoAcquireLockEvent(location, time, attributes, handle,
                                         lockType);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode IoReleaseLockCb(OTF2_LocationRef location,
                                  ...
                                  OTF2_LockType lockType) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeIoReleaseLockEvent(location, time, attributes, handle,
                                         lockType);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode IoTryLockCb(OTF2_LocationRef location, OTF2_TimeStamp time,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeIoTryLockEvent(location, time, attributes, handle,
                                     lockType);
    return OTF2_CALLBACK_SUCCESS;
}
...
OTF2_CallbackCode ProgramBeginCb(OTF2_LocationRef location, OTF2_TimeStamp time,
    ...
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeProgramBeginEvent(location, time, attributes, programName,
...
OTF2_CallbackCode ProgramEndCb(OTF2_LocationRef location, OTF2_TimeStamp time,
                               ...
                               int64_t exitStatus) {
    auto tr = static_cast<TraceReader *>(userData);
    tr->writer().writeProgramEndEvent(location, time, attributes, exitStatus);
    return OTF2_CALLBACK_SUCCESS;
}
