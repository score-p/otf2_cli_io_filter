...
using LocalStringFilter = FilterCallback<OTF2_LocationRef, OTF2_StringRef, const char *>;

using LocalAttributeFilter =
    FilterCallback<OTF2_LocationRef, OTF2_AttributeRef, OTF2_StringRef, OTF2_StringRef, OTF2_Type>;

using LocalSystemTreeNodeFilter =
    FilterCallback<OTF2_LocationRef, OTF2_SystemTreeNodeRef, OTF2_StringRef, OTF2_StringRef, OTF2_SystemTreeNodeRef>;

using LocalLocationGroupFilter = FilterCallback<OTF2_LocationRef,
                                                OTF2_LocationGroupRef,
                                                OTF2_StringRef,
                                                OTF2_LocationGroupType,
                                                OTF2_SystemTreeNodeRef>;

using LocalLocationFilter = FilterCallback<OTF2_LocationRef,
                                           OTF2_LocationRef,
                                           OTF2_StringRef,
                                           OTF2_LocationType,
                                           uint64_t,
...
using LocalRegionFilter = FilterCallback<OTF2_LocationRef,
                                         OTF2_RegionRef,
                                         OTF2_StringRef,
                                         OTF2_StringRef,
                                         OTF2_StringRef,
...
using LocalCallsiteFilter =
    FilterCallback<OTF2_LocationRef, OTF2_CallsiteRef, OTF2_StringRef, uint32_t, OTF2_RegionRef, OTF2_RegionRef>;

using LocalCallpathFilter = FilterCallback<OTF2_LocationRef, OTF2_CallpathRef, OTF2_CallpathRef, OTF2_RegionRef>;

using LocalGroupFilter = FilterCallback<OTF2_LocationRef,
                                        OTF2_GroupRef,
                                        OTF2_StringRef,
                                        OTF2_GroupType,
                                        OTF2_Paradigm,
...
using LocalMetricMemberFilter = FilterCallback<OTF2_LocationRef,
...
using LocalMetricClassFilter = FilterCallback<OTF2_LocationRef,
                                              OTF2_MetricRef,
                                              uint8_t,
                                              const OTF2_MetricMemberRef *,
                                              OTF2_MetricOccurrence,
                                              OTF2_RecorderKind>;

using LocalMetricInstanceFilter =
    FilterCallback<OTF2_LocationRef, OTF2_MetricRef, OTF2_MetricRef, OTF2_LocationRef, OTF2_MetricScope, uint64_t>;

using LocalCommFilter = FilterCallback<OTF2_LocationRef, OTF2_CommRef, OTF2_StringRef, OTF2_GroupRef, OTF2_CommRef>;

using LocalParameterFilter = FilterCallback<OTF2_LocationRef, OTF2_ParameterRef, OTF2_StringRef, OTF2_ParameterType>;

using LocalRmaWinFilter = FilterCallback<OTF2_LocationRef, OTF2_RmaWinRef, OTF2_StringRef, OTF2_CommRef>;

using LocalMetricClassRecorderFilter = FilterCallback<OTF2_LocationRef, OTF2_MetricRef, OTF2_LocationRef>;

using LocalSystemTreeNodePropertyFilter =
    FilterCallback<OTF2_LocationRef, OTF2_SystemTreeNodeRef, OTF2_StringRef, OTF2_Type, OTF2_AttributeValue>;

using LocalSystemTreeNodeDomainFilter = FilterCallback<OTF2_LocationRef, OTF2_SystemTreeNodeRef, OTF2_SystemTreeDomain>;

using LocalLocationGroupPropertyFilter =
    FilterCallback<OTF2_LocationRef, OTF2_LocationGroupRef, OTF2_StringRef, OTF2_Type, OTF2_AttributeValue>;

using LocalLocationPropertyFilter =
    FilterCallback<OTF2_LocationRef, OTF2_LocationRef, OTF2_StringRef, OTF2_Type, OTF2_AttributeValue>;

using LocalCartDimensionFilter =
    FilterCallback<OTF2_LocationRef, OTF2_CartDimensionRef, OTF2_StringRef, uint32_t, OTF2_CartPeriodicity>;

using LocalCartTopologyFilter = FilterCallback<OTF2_LocationRef,
...
using LocalCartCoordinateFilter =
    FilterCallback<OTF2_LocationRef, OTF2_CartTopologyRef, uint32_t, uint8_t, const uint32_t *>;

using LocalSourceCodeLocationFilter =
    FilterCallback<OTF2_LocationRef, OTF2_SourceCodeLocationRef, OTF2_StringRef, uint32_t>;

using LocalCallingContextFilter = FilterCallback<OTF2_LocationRef,
...
using LocalCallingContextPropertyFilter =
    FilterCallback<OTF2_LocationRef, OTF2_CallingContextRef, OTF2_StringRef, OTF2_Type, OTF2_AttributeValue>;

using LocalInterruptGeneratorFilter = FilterCallback<OTF2_LocationRef,
...
using LocalIoFilePropertyFilter =
    FilterCallback<OTF2_LocationRef, OTF2_IoFileRef, OTF2_StringRef, OTF2_Type, OTF2_AttributeValue>;

using LocalIoRegularFileFilter =
    FilterCallback<OTF2_LocationRef, OTF2_IoFileRef, OTF2_StringRef, OTF2_SystemTreeNodeRef>;

using LocalIoDirectoryFilter = FilterCallback<OTF2_LocationRef, OTF2_IoFileRef, OTF2_StringRef, OTF2_SystemTreeNodeRef>;

using LocalIoHandleFilter = FilterCallback<OTF2_LocationRef,
                                           OTF2_IoHandleRef,
                                           OTF2_StringRef,
                                           OTF2_IoFileRef,
                                           OTF2_IoParadigmRef,
...
using LocalIoPreCreatedHandleStateFilter =
    FilterCallback<OTF2_LocationRef, OTF2_IoHandleRef, OTF2_IoAccessMode, OTF2_IoStatusFlag>;

using LocalCallpathParameterFilter =
    FilterCallback<OTF2_LocationRef, OTF2_CallpathRef, OTF2_ParameterRef, OTF2_Type, OTF2_AttributeValue>;
...
class IFilterCallbacks
{
  public:
    struct Callbacks
    {
        ...
        LocalSystemTreeNodePropertyFilter local_system_tree_node_property_callback;
        ...
        LocalCallingContextPropertyFilter local_calling_context_property_callback;
        ...
        LocalIoPreCreatedHandleStateFilter local_io_pre_created_handle_state_callback;
