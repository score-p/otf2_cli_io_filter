...
public:
    ...
    virtual void
    handleGlobalClockProperties(uint64_t timerResolution,
...
uint64_t traceLength)
    ...
    virtual void
    handleGlobalParadigm(OTF2_Paradigm paradigm,
OTF2_StringRef name,
...
OTF2_RegionRef leftRegion)
    ...
    virtual void
    handleGlobalCallpath(OTF2_CallpathRef self,
...
uint64_t scope)
    ...
    virtual void
    handleGlobalComm(OTF2_CommRef self,
OTF2_StringRef name,
OTF2_GroupRef group,
OTF2_CommRef parent)
    {}
    ...
    virtual void
    handleGlobalParameter(OTF2_ParameterRef self,
OTF2_StringRef name,
OTF2_ParameterType parameterType)
    ...
    virtual void
    handleGlobalRmaWin(OTF2_RmaWinRef self,
OTF2_StringRef name,
OTF2_CommRef comm)
    {}
...
const uint32_t* coordinates)
    ...
    virtual void
    handleGlobalSourceCodeLocation(OTF2_SourceCodeLocationRef self,
OTF2_StringRef file,
uint32_t lineNumber)
    {}
...
OTF2_AttributeValue value)
    ...
    virtual void
    handleGlobalIoRegularFile(OTF2_IoFileRef self,
OTF2_StringRef name,
OTF2_SystemTreeNodeRef scope)
    ...
    virtual void
    handleGlobalIoDirectory(OTF2_IoFileRef self,
OTF2_StringRef name,
OTF2_SystemTreeNodeRef scope)
    {}
...
double standardDeviation)
    ...
    virtual void
    handleLocalString(OTF2_LocationRef readLocation,
                            OTF2_StringRef self,
const char* string)
    {}
...
uint64_t scope)
    ...
    virtual void
    handleLocalComm(OTF2_LocationRef readLocation,
                            OTF2_CommRef self,
OTF2_StringRef name,
OTF2_GroupRef group,
OTF2_CommRef parent)
...
OTF2_ParameterType parameterType)
    ...
    virtual void
    handleLocalRmaWin(OTF2_LocationRef readLocation,
                            OTF2_RmaWinRef self,
OTF2_StringRef name,
OTF2_CommRef comm)
    {}
...
uint32_t numberOfRequestedThreads)
    ...
    virtual void
    handleOmpJoinEvent(OTF2_LocationRef    location,
                              OTF2_TimeStamp      time,
                              OTF2_AttributeList* attributes)
    {}
